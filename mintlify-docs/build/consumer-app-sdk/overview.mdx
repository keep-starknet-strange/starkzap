...
<CardGroup cols={3}>
  ...
  >
    Ready-to-use integrations with major Starknet services including AVNU Paymaster, Privy, Cartridge Controller, and Chainrails.
  </Card>
  <Card
...
- **Cross-chain Payments** - Cross-chain, multi-token, and fiat deposits/payments settled on Starknet ([learn more](/build/consumer-app-sdk/payment))
...
- **Feature Modules** - Token ops, staking, transactions, payments, type-safe primitives
...
- [Integrations](/build/consumer-app-sdk/integrations/avnu-paymaster) - AVNU Paymaster, Privy, Cartridge, Chainrails
