...
| `.confidentialFund(c, details)`    | Fund a confidential account                    |
| `.confidentialTransfer(c, details)`| Private transfer to another account            |
| `.confidentialWithdraw(c, details)`| Withdraw to a public address                   |
| `.confidentialRagequit(c, details)`| Emergency full withdrawal                      |
| `.confidentialRollover(c, details)`| Activate pending balance                       |
