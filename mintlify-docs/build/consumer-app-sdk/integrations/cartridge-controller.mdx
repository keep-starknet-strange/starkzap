...
The Starkzap integrates seamlessly with Cartridge Controller, making it perfect for gaming applications where you want seamless, gasless transactions.
...
The Cartridge Controller is included as a peer dependency of the Starkzap:
