...
<AccordionGroup>
  ...
  <Accordion title="Payments">
    ...
    Enable **cross-chain, multi-token payment acceptance** powered by [Chainrails](https://chainrails.io). This allows users to pay from any blockchain (Ethereum, Base, Arbitrum, etc.) and you receive funds on Starknet.

    **What you can do:**
    - 💳 **Accept payments from any chain** — Users can pay with ETH, USDC, USDT, and more from 11+ blockchains
    - 🌉 **Automatic bridging** — Chainrails handles the entire cross-chain transfer
    - 💰 **Receive on Starknet** — Get settled directly in your preferred token
    - 🎨 **Beautiful payment modal** — Embedded UI for seamless user experience

    First, get your API key from the [Chainrails Dashboard](https://dashboard.chainrails.io):
