...
NativeController::NativeController(
    ...
    props["ubrn_uniffi_bless_ControllerAccount_fn_func_ffi_controlleraccount__bless_pointer"] = jsi::Function::createFromHostFunction(
        rt,
        jsi::PropNameID::forAscii(rt, "ubrn_uniffi_bless_ControllerAccount_fn_func_ffi_controlleraccount__bless_pointer"),
        1,
        [this](jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_bless_ControllerAccount_fn_func_ffi_controlleraccount__bless_pointer(rt, thisVal, args, count);
        }
    );
    props["ubrn_uniffi_bless_Owner_fn_func_ffi_owner__bless_pointer"] = jsi::Function::createFromHostFunction(
        rt,
        jsi::PropNameID::forAscii(rt, "ubrn_uniffi_bless_Owner_fn_func_ffi_owner__bless_pointer"),
        1,
        [this](jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_bless_Owner_fn_func_ffi_owner__bless_pointer(rt, thisVal, args, count);
        }
    );
    props["ubrn_uniffi_bless_SessionAccount_fn_func_ffi_sessionaccount__bless_pointer"] = jsi::Function::createFromHostFunction(
        rt,
        jsi::PropNameID::forAscii(rt, "ubrn_uniffi_bless_SessionAccount_fn_func_ffi_sessionaccount__bless_pointer"),
        1,
        [this](jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_bless_SessionAccount_fn_func_ffi_sessionaccount__bless_pointer(rt, thisVal, args, count);
        }
    );
}
...
jsi::Value NativeController::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
...
}jsi::Value NativeController::cpp_uniffi_bless_ControllerAccount_fn_func_ffi_controlleraccount__bless_pointer(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
...
}jsi::Value NativeController::cpp_uniffi_bless_Owner_fn_func_ffi_owner__bless_pointer(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
    auto pointer = uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]);
    auto static destructor = [](uint64_t p) {
        RustCallStatus status = {0};
    ...
    auto obj = jsi::Object::createFromHostObject(rt, ptrObj);
    return jsi::Value(rt, obj);
}jsi::Value NativeController::cpp_uniffi_bless_SessionAccount_fn_func_ffi_sessionaccount__bless_pointer(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count) {
    auto pointer = uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]);
    auto static destructor = [](uint64_t p) {
        RustCallStatus status = {0};
