...
- [Confidential](classes/Confidential.md)
...
- [ConfidentialState](interfaces/ConfidentialState.md)
- [NetworkPreset](interfaces/NetworkPreset.md)
- [ConnectCartridgeBaseOptions](interfaces/ConnectCartridgeBaseOptions.md)
- [CartridgeWalletInterface](interfaces/CartridgeWalletInterface.md)
